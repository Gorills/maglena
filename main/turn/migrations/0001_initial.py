    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='turn.turn', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Слайд',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_keywords', models.CharField(max_length=200, verbose_name='Ключевые слова')),
                ('slug', models.SlugField(unique=True)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='servise', to='turn.turn', verbose_name='Категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price', to='turn.turn', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Прайс',
